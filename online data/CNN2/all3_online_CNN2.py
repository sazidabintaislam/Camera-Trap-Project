...
train_data_path = "C:\\Users\\data\\online data\\CNN2\\all3species_CNN2\\train"
valid_data_path = "C:\\Users\\data\\online data\\CNN2\\all3species_CNN2\\valid"
test_data_path = "C:\\Users\\data\\online data\\CNN2\\all3species_CNN2\\test"
...
model.save("all3_online_CNN2.h5")
...
plt.title('model accuracy for all three class')
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
plt.title('model loss all three class')
plt.ylabel('loss')
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='best')
...
#print(cm)
plt.savefig('all3_Conf_CNN2.png')
plt.show()
