...
- created target species/ and background/ subfolders inside train/ validation/ and test folder and put images inside conrresponing folder 
...
train_data_path = "C:\\Users\\camera trap\\CNN2\\lizard_background_CNN2\\train"
valid_data_path = "C:\\Users\\camera trap\\CNN2\\lizard_background_CNN2\\valid"
test_data_path = "C:\\Users\\camera trap\\CNN2\\lizard_background_CNN2\\test"
...
num_of_train_samples = 2890
num_of_valid_samples = 700
...
plt.title('model accuracy of lizard Vs background')
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
plt.title('model loss of lizard Vs background')
plt.ylabel('loss')
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='best')
...
plt.figure(3)
plot_confusion_matrix(cm, target_names, title='Confusion matrix of lizard Vs background')
#print(cm)
plt.savefig('lizard_conf_CNN2.png')
plt.show()
